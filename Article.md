...
The main part of the network can be found in the middle of the figure. As the name already suggests there are several __convolutional layers__, which lead to the final __features layers__.
...
In the last fully connected dense layers the classification itself takes place. With all the presented or missing features of the previous layers a decision can be made __how to classify__.
